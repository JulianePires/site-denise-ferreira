...
const imagens: ChaveValor<Imagem> = {
  logoAmarelo: {
    src: LogoAmarelo.src,
    alt: 'Logotipo Amarelo Denise Ferreira',
  },
  logoAzul: {
    src: LogoAzul.src,
    alt: 'Logotipo Azul Denise Ferreira',
  },
  logoAzulPetroleo: {
    src: LogoAzulPetroleo.src,
    alt: 'Logotipo AzulPetroleo Denise Ferreira',
  },
  logoBranca: {
    src: LogoBranca.src,
    alt: 'Logotipo Branca Denise Ferreira',
  },
  logoLaranja: {
    src: LogoLaranja.src,
    alt: 'Logotipo Laranja Denise Ferreira',
  },
  logoPreta: {
    src: LogoPreta.src,
    alt: 'Logotipo Preta Denise Ferreira',
  },
  logoVinho: {
    src: LogoVinho.src,
    alt: 'Logotipo Vinho Denise Ferreira',
  },
  sankofaAmarelo: {
    src: SankofaAmarelo.src,
    alt: 'Sankofa Amarelo',
  },
  sankofaAzul: {
    src: SankofaAzul.src,
  ...
  sankofaBranco: {
    src: SankofaBranco.src,
    alt: 'Sankofa Branco',
  },
  sankofaVinho: {
    src: SankofaVinho.src,
    alt: 'Sankofa Vinho',
  },
  sankofaLaranjaAberto: {
    src: SankofaLaranjaAberto.src,
    alt: 'Sankofa Laranja Aberto',
  },
  sankofaLongaAmarela: {
    src: SankofaLongaAmarela.src,
    alt: 'Sankofa Longa Amarela',
  },
  sankofaLongaAzul: {
    src: SankofaLongaAzul.src,
    alt: 'Sankofa Longa Azul',
  },
  sankofaLongaBranco: {
    src: SankofaLongaBranco.src,
    alt: 'Sankofa Longa Branco',
  },
  sankofaLongaLaranja: {
    src: SankofaLongaLaranja.src,
    alt: 'Sankofa Longa Laranja',
  },
  sankofaLongaTerra: {
  ...
  texturaAzulPetroleo: {
    src: TexturaAzulPetroleo.src,
    alt: 'Textura AzulPetroleo',
  },
  texturaVinho: {
    src: TexturaVinho.src,
    alt: 'Textura Vinho',
  },
  texturaLaranja: {
    src: TexturaLaranja.src,
    alt: 'Textura Laranja',
  },
  texturaTerra: {
